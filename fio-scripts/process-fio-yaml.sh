...
########################################################
#
# Process the resutls of a set of yaml output files
# to work properly the script needs a few additional files
# generated by generate-X-fio.sh and run-fio.sh
#
########################################################
